    ...
    <>
      ...
      <div className="bg-[#082c54] h-screen">
        ...
        <div className="flex justify-center mt-[14px] text-slate-400 font-medium">
            <input type="text" placeholder="Your birth year" className="w-[250px]  placeholder-slate-50 placeholder-opacity-25 bg-[#0c3f79] pl-[10px] text-xs h-[35px] border-[1px] border-cyan-900 rounded-md" />
        </div>
        <div className="flex justify-center mt-[18px]">
            <button className="text-white h-[35px] text-xs bg-[#8493a5] w-[250px] rounded-md hover:bg-cyan-500 hover:text-black">Continue</button>
        </div>
      </div>
    </>
  );
